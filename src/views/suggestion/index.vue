<template>
  <div>
    ...
    <div style="margin: 10px">
      <el-table :data="stuList" style="width: 100%; height: 405px" border>
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              v-premission="'shenpi:update'"
              @click="settleSuggestion(scope.row)"
              >处理
            </el-button>
            <el-button
              type="text"
              ...
              v-premission="'shenpi:update'"
              @click="approvalSuggestion(scope.row)"
              >审批
            </el-button>
            <el-button
              type="text"
              size="small"
              icon="el-icon-delete"
              v-premission="'shenpi:remove'"
              @click="deleteSuggestion(scope.row)"
              >删除</el-button
            >
          </template>
        </el-table-column>
